...
// import {menuIcon} from './utils/boilerplate-icons.js';

class Boilerplate extends connect(store)(LitElement) {
...
window.customElements.define('boilerplate-app', Boilerplate);
